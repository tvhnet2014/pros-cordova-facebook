  ...
  ui: function(params, cb) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                FB._nativeInterface.login(params, cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on login!' + e);});
                break;
            ...
            case 'permissions.oauth':
                ...
                break;
            case 'auth.logout':
                FB._nativeInterface.logout(cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on logout!' + e);});
                break;
            case 'auth.status':
                FB._nativeInterface.getLoginStatus(cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on auth.status!' + e);});
                break;
            case 'login.status':
                FB._nativeInterface.getLoginStatus(cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on auth.status!' + e);});
                break;
            case 'feed':
                FB._nativeInterface.dialog(params, cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on auth.status!' + e);});
                break;
            case 'apprequests':
                FB._nativeInterface.dialog(params, cb, function(e) {FB.log('Cordova Facebook Connect plugin fail on auth.status!' + e);});
            break;
...
FB.provide('', {
  ...
  init: function(options) {
    ...
    if (FB._nativeInterface) {
      FB._nativeInterface.init(FB._apiKey, function(e) {alert('Cordova Facebook Connect plugin fail on init! ' + e);});
    }
